#ifndef EMPHASIZE_SETTING_POINTER_HPP
#define EMPHASIZE_SETTING_POINTER_HPP

/* Emphasize Setting - partial specialization for pointers
// Emphasize_Setting_pointer.hpp
//
...
namespace Emphasize {
    ...
    // Setting <T*>
    //  - connects a variable to Settings machinery through its pointer
    ...
    class Setting <T *>
        ...
        public:
            ...
            operator const T & () const { return *this->pointer; };
...
#include "Emphasize_Setting_pointer.tcc"
#endif
