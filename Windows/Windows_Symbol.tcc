...
template <typename P>
bool Windows::Symbol (const wchar_t * module, P & pointer, const char * name) {
    if (HMODULE h = GetModuleHandleW (module))
...
template <typename P>
bool Windows::Symbol (const wchar_t * module, P & pointer, unsigned short index) {
    if (HMODULE h = GetModuleHandleW (module))
